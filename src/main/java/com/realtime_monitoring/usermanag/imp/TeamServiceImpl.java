...
public class TeamServiceImpl implements TeamService {
    ...
    public TeamResponse updateTeam(UUID teamId, UpdateTeamRequest request) {
        ...
        // Tenant tenant =
        // tenantRepository.findById(request.getTenantId()).orElseThrow(() -> new
        // ResourceNotFoundException("Tenant not found"));
        // team.setTenant(tenant);
        // }
    ...
    public void deleteTeam(UUID teamId) {
        ...
        userProducer.sendTeamDeleted(teamId);
